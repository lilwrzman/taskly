-- CreateEnum
CREATE TYPE "ItemStatus" AS ENUM ('TODO', 'ONPROGRESS', 'COMPLETED');

-- CreateEnum
CREATE TYPE "MemberRole" AS ENUM ('LEADER', 'MEMBER', 'GUEST');
...
CREATE TABLE "User" (
    ...
    "image" TEXT NOT NULL DEFAULT '/image/default.png',
...
-- AddForeignKey
ALTER TABLE "ItemCategory" ADD CONSTRAINT "ItemCategory_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
